...
import xyz.lunify.androidminer.api.PaymentItem;
import xyz.lunify.androidminer.api.ProviderData;
import xyz.lunify.androidminer.widgets.PaymentInfoAdapter;
...
public class PaymentsActivity extends BaseActivity implements PaymentInfoAdapter.OnShowPaymentListener {
    ...
    public void onShowPayment(final PaymentItem paymentItem) {
        String paymentURL = "https://explorer.lunifyx.xyz/tx?tx_info=" + paymentItem.mHash;
