...
import static xyz.lunify.androidminer.Tools.getReadableDifficultyString;
import static xyz.lunify.androidminer.Tools.getReadableHashRateString;
import static xyz.lunify.androidminer.Tools.parseCurrency;
import static xyz.lunify.androidminer.Tools.parseCurrencyFloat;
import static xyz.lunify.androidminer.Tools.tryParseLong;
...
public final class NodejsPool extends ProviderAbstract {
    ...
    protected void onBackgroundFetchData() {
        ...
        try {
            ...
            mBlockData.network.lastRewardAmount =  parseCurrency(joNetworkStats.optString("value", "0"), denominationUnit, denominationUnit, "LFI");
