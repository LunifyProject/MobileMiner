...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView tvLunify = view.findViewById(R.id.tvLunify);
        tvLunify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri uri = Uri.parse(getString(R.string.LunifyLinkClean));
        ...
        tvDisclaimer.setLinkTextColor(getResources().getColor(R.color.c_purple));
