...
import xyz.lunify.androidminer.api.ChangelogItem;
import xyz.lunify.androidminer.api.IProviderListener;
import xyz.lunify.androidminer.api.PoolItem;
import xyz.lunify.androidminer.api.ProviderData;
import xyz.lunify.androidminer.api.ProviderManager;
import xyz.lunify.androidminer.controls.SimpleTriangleIndicator;
        ...
        implements BottomNavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meterCores.makeSections(1, getResources().getColor(R.color.c_green), Style.SQUARE);
        meterCores.setMaxSpeed(nNbMaxCores);
        meterCores.speedTo(0, 0);

        // Hashrate
        TubeSpeedometer meterHashrate = findViewById(R.id.meter_hashrate);
        meterHashrate.makeSections(1, getResources().getColor(R.color.c_purple), Style.SQUARE);
        ...
        meterHashrate_avg.makeSections(1, getResources().getColor(android.R.color.transparent), Style.SQUARE);
        ...
        meterHashrate_max.makeSections(1, getResources().getColor(android.R.color.transparent), Style.SQUARE);
    ...
    private void updateTemperaturesChart() {
        ...
        if (data != null && data.getDataSetCount() > 0) {
            ...
            set1.setColor(getResources().getColor(R.color.c_purple));
            set1.setAxisDependency(YAxis.AxisDependency.LEFT);
    ...
    private void updatePayoutWidget(ProviderData d) {
        if(d.isNew) {
            ...
            sBalance = sBalance.replace("LFI", "").trim();
    ...
    public void enablePayoutWidget(boolean enable, String text) {
        ...
        if (enable) {
            ...
            TextView tvLFIUnit = findViewById(R.id.lfiunit);
            tvLFIUnit.setVisibility(View.VISIBLE);
            ...
            TextView tvLFIUnit = findViewById(R.id.lfiunit);
            tvLFIUnit.setVisibility(View.INVISIBLE);
    ...
    private Spannable formatLogOutputText(String text) {
        ...
        if (speed) {
            ...
            textSpan.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.c_purple)), i+1, max+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private void showNotificationPause() {
        ...
        notificationBuilder.setContentTitle(getResources().getString(R.string.lunifymining));
        ...
        notificationBuilder.setSmallIcon(android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? R.drawable.logo_icon_white : R.drawable.logo_icon_white);
    ...
    private void showNotificationResume() {
        ...
        notificationBuilder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher_round));
        notificationBuilder.setSmallIcon(R.drawable.logo_icon_white);
        notificationBuilder.setOngoing(true);
        notificationBuilder.setOnlyAlertOnce(true);
        notificationBuilder.build();
    ...
    private void saveBitmap(Bitmap bitmap) {
        ...
        imagePath = new File(contextOfApplication.getExternalFilesDir(Environment.DIRECTORY_PICTURES), "lunify_miner_screenshot.png");
